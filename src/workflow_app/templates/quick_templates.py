...
#   /auto-improove:anthropic         — sem capabilities catalogadas ainda
#
# Por iteração: cmd×63, cli-bp×63, guardrails×13, blueprints×32, templates×5, skills×2
# Total de entradas: 356   (cada par = /clear + comando)
#
# Para recalcular: /auto-improove:update-workflow-template

TEMPLATE_AUTO_IMPROOVE: list[CommandSpec] = [
    # ── /auto-improove:cmd (63×) ─ pos 0–125
    *_repeats("/auto-improove:cmd",        _O, 63,   0),
    # ── /auto-improove:cli-bp (63×) ─ pos 126–251
    *_repeats("/auto-improove:cli-bp",     _O, 63, 126),
    # ── /auto-improove:guardrails (13×) ─ pos 252–277
    *_repeats("/auto-improove:guardrails", _O, 13, 252),
    # ── /auto-improove:blueprints (32×) ─ pos 278–341
    *_repeats("/auto-improove:blueprints", _O, 32, 278),
    # ── /auto-improove:templates (5×) ─ pos 342–351
    *_repeats("/auto-improove:templates",  _O,  5, 342),
    # ── /auto-improove:skills (2×) ─ pos 352–355
    *_repeats("/auto-improove:skills",     _O,  2, 352),
]
# << END AUTO-GENERATED >>
