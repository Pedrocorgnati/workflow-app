...
TEMPLATE_INTAKE_REVIEW: list[CommandSpec] = [
    ...
    # Bloco 4.6: gera de fato as artes especificadas (Codex/gpt-image-1) e corrige
    # o vinculo no codigo. pos cosmetico (ordem de execucao = ordem da lista).
    _spec("/pictures-create",                _S, _A, 41, effort=EffortLevel.STANDARD),
...
TEMPLATE_INTAKE_MAX_REVIEW: list[CommandSpec] = [
    ...
    # Gera de fato as artes especificadas (Codex/gpt-image-1) e corrige o vinculo
    # no codigo. pos cosmetico (ordem de execucao = ordem da lista).
    _spec("/pictures-create",                _S, _A, 28, effort=EffortLevel.STANDARD),
...
#   /auto-improove:fases             — WORKFLOW.md não possui seções de fase no momento
#
# Por iteração: cmd×61, cli-bp×61, guardrails×13, blueprints×32, templates×5, skills×2, anthropic×5
# Total de entradas: 358   (cada par = /clear + comando)
#
# Para recalcular: /auto-improove:update-workflow-template

TEMPLATE_AUTO_IMPROOVE: list[CommandSpec] = [
    # ── /auto-improove:cmd (61×) ─ pos 0–121
    *_repeats("/auto-improove:cmd",        _O, 61,   0),
    # ── /auto-improove:cli-bp (61×) ─ pos 122–243
    *_repeats("/auto-improove:cli-bp",     _O, 61, 122),
    # ── /auto-improove:guardrails (13×) ─ pos 244–269
    *_repeats("/auto-improove:guardrails", _O, 13, 244),
    # ── /auto-improove:blueprints (32×) ─ pos 270–333
    *_repeats("/auto-improove:blueprints", _O, 32, 270),
    # ── /auto-improove:templates (5×) ─ pos 334–343
    *_repeats("/auto-improove:templates",  _O,  5, 334),
    # ── /auto-improove:skills (2×) ─ pos 344–347
    *_repeats("/auto-improove:skills",     _O,  2, 344),
    # ── /auto-improove:anthropic (5×) ─ pos 348–357
    *_repeats("/auto-improove:anthropic",  _O,  5, 348),
]
# << END AUTO-GENERATED >>
