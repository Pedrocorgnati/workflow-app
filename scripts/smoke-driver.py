...
SCENARIOS: list[tuple[str, str]] = [
    ...
    ("04-radio-default", "Main LLM `queue-div-main-llm` default = Claude"),
    ("05-claude-publica", "Botao Claude publica em terminal-interactive-output"),
    ("06-kimi-publica", "Main LLM=Kimi + botao dinamico publica em terminal-workspace-output"),
    ("07-codex-toast", "Main LLM=Codex + botao dinamico exibe toast canonico (T7)"),
